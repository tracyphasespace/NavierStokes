...
The process is automatic and instantaneous---the exchange identity is an algebraic constraint, not a dynamical relaxation. Traditional PDE analysis treats $\nu$ as given and asks whether solutions remain smooth. This is ill-posed because it ignores the physical mechanism encoded in $\nu$. By restoring $\Delta_p$, we supply the missing information: energy has a reservoir (molecular rotation) that prevents unbounded concentration.
